...
class Aceleraciones_Rotaciones_Velocidades
{
    ...
    {
        // Usar Task para manejar la lectura de datos y el procesamiento simultáneamente
        Task.Run(() => {
            while (true)
            {
                ReceiveMessage();
            ...
            if (serialPort.IsOpen)
            {
                try
                {
                    ...
                    if (dataParts.Length == 4)
                    {
                        ...
                        // Aquí podrías añadir la lógica para comparar estos valores con los datos del MSFS2020
                    }
                }
